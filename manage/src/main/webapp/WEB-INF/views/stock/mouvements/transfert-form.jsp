...
<main class="content">
    <div class="container form-container">
        <div class="page-header">
            <h1>Créer un Transfert de Stock</h1>
        </div>
        ...
        <form method="post" action="/stock/mouvements/transferts/creer" class="form">
            <div class="form-section">
                <h3>Informations Transfert</h3>
                ...
                <div class="form-row">
                    <div class="form-group col-6">
                        <label for="depotDepart">Dépôt Départ *</label>
                        <select id="depotDepart" name="depotDepart" class="form-control" required>
                            <option value="">-- Sélectionner --</option>
                    ...
                    <div class="form-group col-6">
                        ...
                        <select id="depotDestination" name="depotDestination" class="form-control" required>
                            <option value="">-- Sélectionner --</option>
                            <c:forEach var="depot" items="${depots}">
                                <option value="${depot.id}">${depot.nom}</option>
                            </c:forEach>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-6">
                        <label for="numeroReference">Numéro Référence *</label>
                        <input type="text" id="numeroReference" name="numeroReference" class="form-control" 
                               required placeholder="Bon de transfert">
                    </div>
                </div>
            </div>

            <div class="form-actions">
                <button type="submit" class="btn btn-info">Créer Transfert</button>
